...
//   return (
//     <div className="min-h-screen w-full bg-white text-gray-900 flex flex-col items-center justify-center px-6">
//       <motion.div
//         className="max-w-6xl w-full text-center py-20"
//         initial={{ opacity: 0 }}
//         animate={{ opacity: 1 }}
...
//         {/* Heading */}
//         <motion.h1
//           className="text-5xl sm:text-6xl font-extrabold leading-tight bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 text-transparent bg-clip-text"
//           initial={{ y: -50, opacity: 0 }}
//           animate={{ y: 0, opacity: 1 }}
//           transition={{ duration: 0.8 }}
//         >
//           Discover the Magic of <br /> Calculating with Me
//         </motion.h1>

//         {/* Subheading */}
//         <motion.p
//           className="text-xl sm:text-2xl text-gray-700 mt-6"
//           initial={{ opacity: 0 }}
//           animate={{ opacity: 1 }}
...
//         {/* Buttons Section */}
//         <motion.div
//           className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-6 flex-wrap"
...
//           <Link
//             href="/calculators"
//             className="group bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white px-8 py-4 rounded-xl shadow-lg text-lg font-semibold flex items-center gap-3 transition hover:scale-105"
//           >
...
//           <Link
//             href="/invoices"
//             className="group bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 text-white px-8 py-4 rounded-xl shadow-lg text-lg font-semibold flex items-center gap-3 transition hover:scale-105"
//           >
...
//           <Link
//             href="/text-tools"
//             className="group bg-gradient-to-r from-pink-500 to-red-500 hover:from-pink-600 hover:to-red-600 text-white px-8 py-4 rounded-xl shadow-lg text-lg font-semibold flex items-center gap-3 transition hover:scale-105"
//           >
...
//         {/* Feature Cards */}
//         <motion.div
//           className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-20 text-center"
//           initial="hidden"
//           whileInView="visible"
//           viewport={{ once: true }}
...
//             icon: <FaBolt className="text-4xl text-yellow-500 mx-auto mb-4" />,
//           }, {
//             title: 'Smart Invoices',
//             desc: 'Professional receipts with branding support.',
//             icon: <FaFileInvoiceDollar className="text-4xl text-green-600 mx-auto mb-4" />,
//           }, {
//             title: 'Designed for You',
//             desc: 'Simple UI with beautiful animations & dark mode.',
//             icon: <FaMagic className="text-4xl text-pink-500 mx-auto mb-4" />,
//           }, {
//             title: '49++ Tools Ready',
//             desc: 'From EMI to Tax to Scientific Math & more.',
//             icon: <FaTools className="text-4xl text-purple-600 mx-auto mb-4" />,
//           }].map((item, i) => (
//             <motion.div
//               key={i}
...
//         {/* 📚 Articles Section */}
//         <motion.div
//           className="mt-24 space-y-12 text-left"
//           initial={{ opacity: 0 }}
//           animate={{ opacity: 1 }}
//           transition={{ delay: 1.2 }}
//         >
//           <div className="bg-white shadow-lg rounded-xl p-6 border-l-4 border-purple-500">
//             <h2 className="text-2xl font-bold text-purple-700 mb-3">Why You Need Smart Calculators in 2025</h2>
...
//             <h2 className="text-2xl font-bold text-green-700 mb-3">How to Use This Platform Effectively</h2>
//             <p className="text-gray-700 leading-relaxed">
...
//         {/* Footer Text */}
//         <motion.div
//           className="mt-20 text-lg text-gray-600 leading-relaxed"
//           initial={{ opacity: 0 }}
//           animate={{ opacity: 1 }}
//           transition={{ delay: 1.5 }}
//         >
//           <p> please try this tools and enjoy for free</p>
//           <p className="mt-2">✨ build with me ___ unlimited free access this all tools for your life</p>
//         </motion.div>
